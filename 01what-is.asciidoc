...
* A game-theoretically sound incentivization scheme (e.g., proof-of-stake rewards plus slashings) to economically secure the state machine in an open pass:[<span class="keep-together">environment</span>]
...
TODO: Update hard fork blocks with the merge

((("Serenity")))((("Ethereum Merge")))Two hard forks, Berlin and London, have also been announced, and we are now in the final stage of Ethereum development, codenamed Serenity. Serenity involves a profound reorganization of the infrastructure that will make Ethereum more scalable, more secure, and more sustainable. It is presented as the execution layer merges with the new proof-of-stake consensus layer.
...
TODO: post merge consensus algortihm
...
TODO: post merge economic security
